...
- 🔐 **Enterprise Security**: RS256 JWT, Argon2id passwords, HIPAA/GDPR compliant
- 🔑 **MFA Support**: TOTP, WebAuthn/Passkeys (phishing-proof)
- ⚡ **Async Support**: Full async/await support for modern Python apps
- 🚀 **Framework Integrations**: FastAPI and Flask out of the box
- 🔄 **Auto Token Refresh**: Automatic token management with retry logic
...
- 💬 [Discord Community](https://discord.gg/zalt)
- 🐛 [Issue Tracker](https://github.com/zalt-io/zalt-auth-python/issues)
- 📧 [Email Support](mailto:support@zalt.io)
